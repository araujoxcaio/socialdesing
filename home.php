    ...
    <center><header>
        ...
        <section id="contact" class="contact bg-primary">
            <div class="container">
                <h2>Participe da comunidade Social Design!</h2>
             ...
             <div class="container">
                <h4>Conheça também outros sites da comunidade Social Design!</h4>
             </div>   
        </section>

        <footer>
            <div class="container">
                <p>&copy; 2017 Social Design. All Rights Reserved.</p>
